...
//every code related must be wrapped in sandpack
function CodeView() {
  const { id } = useParams();
  ...
  return (
    <div className="relative">
      <div className="bg-[#181818] w-full p-2 border">
        <div className="flex items-center justify-center flex-wrap shrink-0 bg-black p-1 w-[140px] gap-4 rounded-full">
          <h2

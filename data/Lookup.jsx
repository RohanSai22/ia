...
export default {
  ...
  INPUT_PLACEHOLDER: "Type your idea and Let us do the magic",
  SIGNIN_HEADING: "Continue With IA 2.0",
  SIGNIN_SUBHEADING:
    "To use IA you must log into an existing account or create one.",
  SIGNIn_AGREEMENT_TEXT:
    "By using IA, you agree to the collection of usage data for analytics.",
...
`,
  ...
  PRICING_OPTIONS: [
    ...
    },
    {
      ...
      tokens: "120K",
      value: 120000,
      desc: "Designed for professionals who need to use IA a few times per week.",
      price: 9.99,
    },
    {
      name: "Pro",
